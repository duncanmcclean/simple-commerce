...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    ...
    redeemCoupon: function redeemCoupon() {
      ...
      this.isSubmitting = true;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(window.redeemCouponEndpoint, {
        code: this.coupon
        ...
        if (response.data.error === true) {
          ...
          _this.isSubmitting = false;
          alert(response.data.message);
          window.paymentIntent = response.data.intent; // change the price of the cart in the dom
        }
...
module.exports = __webpack_require__(/*! /Users/duncan/Sites/commerce/addons/damcclean/commerce/resources/js/web.js */"./resources/js/web.js");
