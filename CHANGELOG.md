...
Before upgrading, please review the [v7 → v8 upgrade guide](https://simple-commerce.duncanmcclean.com/upgrade-guides/v7-to-v8) in case you need to make any manual changes.
