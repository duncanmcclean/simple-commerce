...
If you were implementing a custom 'content driver' previously for something, you will need to review the changes and refactor your implementation. If it helps, here's a link to view [the 'interfaces'](https://github.com/doublethreedigital/simple-commerce/tree/3.x/src/Contracts) behind SC's Data stuff.
