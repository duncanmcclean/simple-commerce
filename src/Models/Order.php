...
class Order extends Model
{
    ...
    protected $fillable = [
        'uuid', 'gateway', 'is_paid', 'is_completed', 'total', 'item_total', 'tax_total', 'shipping_total', 'currency_id', 'order_status_id', 'billing_address_id', 'shipping_address_id', 'customer_id',
    ];
